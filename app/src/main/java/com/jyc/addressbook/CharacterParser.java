package com.jyc.addressbook;


/**
 * Created by chenxinwen on 16/5/6.09:45.
 * Email:191205292@qq.com
 *
 * CharacterParser 这个类是将汉字转换成拼音的类，该拼音没有声调的，
 * 该类是单例类，其中定义了三个方法，在这个demo中用到的是getSelling(String chs)方法，将词组转换成拼音
 *
 */
